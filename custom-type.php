...
function crazball() {
    ...
    $labels = array(
        'name'                  => _x( 'Crazball', 'Post Type General Name', 'text_domain' ),
        'singular_name'         => _x( 'Crazball', 'Post Type Singular Name', 'text_domain' ),
        'menu_name'             => __( 'Crazball', 'text_domain' ),
        'name_admin_bar'        => __( 'Crazball', 'text_domain' ),
        'archives'              => __( 'Item Archives', 'text_domain' ),
        'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
        'all_items'             => __( 'All Items', 'text_domain' ),
        'add_new_item'          => __( 'Add New Item', 'text_domain' ),
    ...
    $args = array(
        'label'                 => __( 'Crazball', 'text_domain' ),
        'description'           => __( 'Crazball', 'text_domain' ),
        'labels'                => $labels,
        'supports'              => array( 'title', 'editor', 'thumbnail', 'custom-fields' ),
        'taxonomies'            => array( 'category', 'post_tag' ),
        'hierarchical'          => false,
    ...
    register_post_type( 'crazball', $args );

}
add_action( 'init', __NAMESPACE__ . '\\crazball', 0 );
